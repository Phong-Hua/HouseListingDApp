...
contract Ownable {
    ...
    event OwnershipTransfer(address owner);
    ...
    /**
    * Modifier accept caller is owner only.
    */
    modifier onlyOwner()
    {
...
contract Pausable is Ownable {
    ...
    event Paused(address add);

    event Unpaused(address add);
    ...
    */
    modifier paused()
    {
        require (_paused == true, "Require contract is paused");
        _;
    }
    ...
    */
    ...
    {
        require (_paused == false, "Require contract is not paused");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(owner != to, "Require the given address is not the owner");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(owner == msg.sender, "Require the transferer is owner");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        if (_tokenOwner[tokenId] != address(0) || _tokenApprovals[tokenId] != address(0) || to == address(0))
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == from, "Require from address is the owner");
        // TODO: require token is being transfered to valid address
        require(!to.isContract(), "Require to address is valid");
        // TODO: clear approval
